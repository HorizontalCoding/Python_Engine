...
def train_model(train_data):
    ...
    # Use seconds and microseconds to generate depth and n_estimators
    depth = 4 + int(current_time) % 7  # Values between 4 and 10
    n_estimators = 1500 + int(current_time * 1000000) % 1001  # Values between 1500 and 2500
