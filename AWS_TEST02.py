...
# Lock for model training to prevent race conditions
...
def get_recommendations():
    ...
    # Lock the model training process to ensure only one training at a time
    with model_lock:
        train_data, _ = train_test_split(df_filter, test_size=0.2, random_state=42)
    ...
    results_df.to_csv('results_with_tour_keywordA.csv', index=False, encoding='utf-8-sig')
